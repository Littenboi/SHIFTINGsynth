...
pub fn get_editor(
    ...
    create_egui_editor(
        ...
        |cx, editor_state| {
            ...
            let blixemi = [
                include_bytes!("../assets/cat-imgs/blixemi/0.png").as_slice(),
                include_bytes!("../assets/cat-imgs/blixemi/1.png").as_slice(),
                include_bytes!("../assets/cat-imgs/blixemi/2.png").as_slice(),
                include_bytes!("../assets/cat-imgs/blixemi/3.png").as_slice(),
                include_bytes!("../assets/cat-imgs/blixemi/4.png").as_slice(),
                include_bytes!("../assets/cat-imgs/blixemi/5.png").as_slice(),
                include_bytes!("../assets/cat-imgs/blixemi/6.png").as_slice(),
                include_bytes!("../assets/cat-imgs/blixemi/7.png").as_slice(),
                include_bytes!("../assets/cat-imgs/blixemi/8.png").as_slice(),
                include_bytes!("../assets/cat-imgs/blixemi/9.png").as_slice(),
            ]
            .iter()
            .enumerate()
            .map(|(i, img)| load_cat_image(&format!("blixemi-{}", i), img))
            .collect();
            cat_images.push(blixemi);

            let frito = [
                include_bytes!("../assets/cat-imgs/frito/0.png").as_slice(),
                include_bytes!("../assets/cat-imgs/frito/1.png").as_slice(),
                include_bytes!("../assets/cat-imgs/frito/2.png").as_slice(),
                include_bytes!("../assets/cat-imgs/frito/3.png").as_slice(),
                include_bytes!("../assets/cat-imgs/frito/4.png").as_slice(),
                include_bytes!("../assets/cat-imgs/frito/5.png").as_slice(),
                include_bytes!("../assets/cat-imgs/frito/6.png").as_slice(),
                include_bytes!("../assets/cat-imgs/frito/7.png").as_slice(),
                include_bytes!("../assets/cat-imgs/frito/8.png").as_slice(),
                include_bytes!("../assets/cat-imgs/frito/9.png").as_slice(),
            ]
            .iter()
            .enumerate()
            .map(|(i, img)| load_cat_image(&format!("frito-{}", i), img))
            .collect();
            cat_images.push(frito);
